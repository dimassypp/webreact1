    ...
    return (
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="#" class="flex items-center">
                <img src="https://th.bing.com/th/id/R.8c741ebee68025d6db4ebe5a54654092?rik=HUQfcdgTmUMKCg&riu=http%3a%2f%2fwww.allroundsecurity.com%2fImages%2fARS+Logo.png&ehk=IK9LzI%2bpd9d3fI8ShS8B4aJAxr9PXwYmO%2b1pYppxAL8%3d&risl=&pid=ImgRaw&r=0" class="mr-3 h-6 sm:h-10" alt="Flowbite Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">AR</span>
            </a>
